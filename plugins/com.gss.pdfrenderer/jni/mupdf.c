...
#define JNI_FN(A) Java_com_gss_pdfrenderer_PDFRendererCore_ ## A
#define PACKAGENAME "com/gss/pdfrenderer"
...
JNI_FN(openFile)(JNIEnv * env, jobject thiz, jstring jfilename)
{
	const char *filename;
	globals *glo;
	fz_context *ctx;
...
JNIEXPORT jlong JNICALL
JNI_FN(openBuffer)(JNIEnv * env, jobject thiz, jstring jmagic)
{
	globals *glo;
	fz_context *ctx;
	jclass clazz;
...
JNI_FN(countPagesInternal)(JNIEnv *env, jobject thiz)
{
...
JNI_FN(fileFormatInternal)(JNIEnv * env, jobject thiz)
{
	char info[64];
	globals *glo = get_globals(env, thiz);
...
JNI_FN(isUnencryptedPDFInternal)(JNIEnv * env, jobject thiz)
{
...
JNI_FN(gotoPageInternal)(JNIEnv *env, jobject thiz, int page)
{
	int i;
	int furthest;
	int furthest_dist = -1;
...
JNI_FN(getPageWidth)(JNIEnv *env, jobject thiz)
{
	globals *glo = get_globals(env, thiz);
...
JNIEXPORT float JNICALL
JNI_FN(getPageHeight)(JNIEnv *env, jobject thiz)
{
	globals *glo = get_globals(env, thiz);
...
JNIEXPORT jboolean JNICALL
JNI_FN(javascriptSupported)(JNIEnv *env, jobject thiz)
{
	globals *glo = get_globals(env, thiz);
	pdf_document *idoc = pdf_specifics(glo->doc);
...
JNIEXPORT jboolean JNICALL
JNI_FN(drawPage)(JNIEnv *env, jobject thiz, jobject bitmap,
...
JNIEXPORT jboolean JNICALL
JNI_FN(updatePageInternal)(JNIEnv *env, jobject thiz, jobject bitmap, int page,
		int pageW, int pageH, int patchX, int patchY, int patchW, int patchH, jlong cookiePtr)
{
	AndroidBitmapInfo info;
	void *pixels;
	...
	if (pc == NULL)
	{
		...
		JNI_FN(gotoPageInternal)(env, thiz, page);
		return JNI_FN(drawPage)(env, thiz, bitmap, pageW, pageH, patchX, patchY, patchW, patchH, (jlong)(intptr_t)cookie);
	}
...
JNIEXPORT jboolean JNICALL
JNI_FN(needsPasswordInternal)(JNIEnv * env, jobject thiz)
{
	globals *glo = get_globals(env, thiz);
...
JNIEXPORT jboolean JNICALL
JNI_FN(authenticatePasswordInternal)(JNIEnv *env, jobject thiz, jstring password)
{
	const char *pw;
	int result;
	globals *glo = get_globals(env, thiz);
...
JNIEXPORT jboolean JNICALL
JNI_FN(hasOutlineInternal)(JNIEnv * env, jobject thiz)
{
	globals *glo = get_globals(env, thiz);
...
JNI_FN(getOutlineInternal)(JNIEnv * env, jobject thiz)
{
	jclass olClass;
	jmethodID ctor;
	jobjectArray arr;
...
JNIEXPORT jobjectArray JNICALL
JNI_FN(searchPage)(JNIEnv * env, jobject thiz, jstring jtext)
{
	jclass rectClass;
	jmethodID ctor;
	jobjectArray arr;
...
JNIEXPORT jobjectArray JNICALL
JNI_FN(text)(JNIEnv * env, jobject thiz)
{
...
JNI_FN(textAsHtml)(JNIEnv * env, jobject thiz)
{
	fz_text_sheet *sheet = NULL;
	fz_text_page *text = NULL;
	fz_device *dev = NULL;
...
JNIEXPORT void JNICALL
JNI_FN(addMarkupAnnotationInternal)(JNIEnv * env, jobject thiz, jobjectArray points, fz_annot_type type)
{
	globals *glo = get_globals(env, thiz);
	fz_context *ctx = glo->ctx;
	fz_document *doc = glo->doc;
...
JNIEXPORT void JNICALL
JNI_FN(addInkAnnotationInternal)(JNIEnv * env, jobject thiz, jobjectArray arcs)
{
	globals *glo = get_globals(env, thiz);
	fz_context *ctx = glo->ctx;
	fz_document *doc = glo->doc;
...
JNIEXPORT void JNICALL
JNI_FN(deleteAnnotationInternal)(JNIEnv * env, jobject thiz, int annot_index)
{
	globals *glo = get_globals(env, thiz);
	fz_context *ctx = glo->ctx;
	fz_document *doc = glo->doc;
...
JNIEXPORT void JNICALL
JNI_FN(destroying)(JNIEnv * env, jobject thiz)
{
	globals *glo = get_globals(env, thiz);
...
JNIEXPORT jobjectArray JNICALL
JNI_FN(getPageLinksInternal)(JNIEnv * env, jobject thiz, int pageNumber)
{
	...
	JNI_FN(gotoPageInternal)(env, thiz, pageNumber);
	pc = &glo->pages[glo->current];
...
JNIEXPORT jobjectArray JNICALL
JNI_FN(getWidgetAreasInternal)(JNIEnv * env, jobject thiz, int pageNumber)
{
	jclass rectFClass;
	jmethodID ctor;
	jobjectArray arr;
...
JNIEXPORT jobjectArray JNICALL
JNI_FN(getAnnotationsInternal)(JNIEnv * env, jobject thiz, int pageNumber)
{
	jclass annotClass;
	jmethodID ctor;
	jobjectArray arr;
...
JNIEXPORT int JNICALL
JNI_FN(passClickEventInternal)(JNIEnv * env, jobject thiz, int pageNumber, float x, float y)
{
	globals *glo = get_globals(env, thiz);
	fz_context *ctx = glo->ctx;
	fz_matrix ctm;
...
JNIEXPORT jstring JNICALL
JNI_FN(getFocusedWidgetTextInternal)(JNIEnv * env, jobject thiz)
{
	char *text = "";
	globals *glo = get_globals(env, thiz);
	fz_context *ctx = glo->ctx;
...
JNIEXPORT int JNICALL
JNI_FN(setFocusedWidgetTextInternal)(JNIEnv * env, jobject thiz, jstring jtext)
{
	const char *text;
	int result = 0;
	globals *glo = get_globals(env, thiz);
...
JNIEXPORT jobjectArray JNICALL
JNI_FN(getFocusedWidgetChoiceOptions)(JNIEnv * env, jobject thiz)
{
	globals *glo = get_globals(env, thiz);
	fz_context *ctx = glo->ctx;
	pdf_document *idoc = pdf_specifics(glo->doc);
...
JNIEXPORT jobjectArray JNICALL
JNI_FN(getFocusedWidgetChoiceSelected)(JNIEnv * env, jobject thiz)
{
	globals *glo = get_globals(env, thiz);
	fz_context *ctx = glo->ctx;
	pdf_document *idoc = pdf_specifics(glo->doc);
...
JNIEXPORT void JNICALL
JNI_FN(setFocusedWidgetChoiceSelectedInternal)(JNIEnv * env, jobject thiz, jobjectArray arr)
{
	globals *glo = get_globals(env, thiz);
	fz_context *ctx = glo->ctx;
	pdf_document *idoc = pdf_specifics(glo->doc);
...
JNIEXPORT int JNICALL
JNI_FN(getFocusedWidgetTypeInternal)(JNIEnv * env, jobject thiz)
{
	globals *glo = get_globals(env, thiz);
	pdf_document *idoc = pdf_specifics(glo->doc);
	pdf_widget *focus;
...
JNIEXPORT int JNICALL
JNI_FN(getFocusedWidgetSignatureState)(JNIEnv * env, jobject thiz)
{
	globals *glo = get_globals(env, thiz);
	pdf_document *idoc = pdf_specifics(glo->doc);
	pdf_widget *focus;
...
JNIEXPORT jstring JNICALL
JNI_FN(checkFocusedSignatureInternal)(JNIEnv * env, jobject thiz)
{
	globals *glo = get_globals(env, thiz);
	pdf_document *idoc = pdf_specifics(glo->doc);
	pdf_widget *focus;
...
JNIEXPORT jboolean JNICALL
JNI_FN(signFocusedSignatureInternal)(JNIEnv * env, jobject thiz, jstring jkeyfile, jstring jpassword)
{
	globals *glo = get_globals(env, thiz);
	fz_context *ctx = glo->ctx;
	pdf_document *idoc = pdf_specifics(glo->doc);
...
JNI_FN(waitForAlertInternal)(JNIEnv * env, jobject thiz)
{
	globals *glo = get_globals(env, thiz);
	jclass alertClass;
	jmethodID ctor;
...
JNIEXPORT void JNICALL
JNI_FN(replyToAlertInternal)(JNIEnv * env, jobject thiz, jobject alert)
{
	globals *glo = get_globals(env, thiz);
	jclass alertClass;
	jfieldID field;
...
JNIEXPORT void JNICALL
JNI_FN(startAlertsInternal)(JNIEnv * env, jobject thiz)
{
	globals *glo = get_globals(env, thiz);
...
JNIEXPORT void JNICALL
JNI_FN(stopAlertsInternal)(JNIEnv * env, jobject thiz)
{
	globals *glo = get_globals(env, thiz);
...
JNIEXPORT jboolean JNICALL
JNI_FN(hasChangesInternal)(JNIEnv * env, jobject thiz)
{
	globals *glo = get_globals(env, thiz);
	pdf_document *idoc = pdf_specifics(glo->doc);
...
JNIEXPORT void JNICALL
JNI_FN(saveInternal)(JNIEnv * env, jobject thiz)
{
	globals *glo = get_globals(env, thiz);
	fz_context *ctx = glo->ctx;
...
JNIEXPORT void JNICALL
JNI_FN(dumpMemoryInternal)(JNIEnv * env, jobject thiz)
{
	globals *glo = get_globals(env, thiz);
	fz_context *ctx = glo->ctx;
...
JNIEXPORT jlong JNICALL
JNI_FN(createCookie)(JNIEnv * env, jobject thiz)
{
	globals *glo = get_globals_any_thread(env, thiz);
	if (glo == NULL)
		return 0;
...
JNIEXPORT void JNICALL
JNI_FN(destroyCookie)(JNIEnv * env, jobject thiz, jlong cookiePtr)
{
	fz_cookie *cookie = (fz_cookie *) (intptr_t) cookiePtr;
	globals *glo = get_globals_any_thread(env, thiz);
	if (glo == NULL)
...
JNIEXPORT void JNICALL
JNI_FN(abortCookie)(JNIEnv * env, jobject thiz, jlong cookiePtr)
{
	fz_cookie *cookie = (fz_cookie *) (intptr_t) cookiePtr;
	if (cookie != NULL)
		cookie->abort = 1;
